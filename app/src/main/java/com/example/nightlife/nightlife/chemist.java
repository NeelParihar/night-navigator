...
public class chemist extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener{
    ...
    private void fetchStores() {
        ...
        if (locationTrack.canGetLocation()) {
            ...
            Call<PlacesPOJO.Root> call = apiService.doplaces("https://maps.googleapis.com/maps/api/place/nearbysearch/json?location="+lat+","+lon+"&radius=1500&type=pharmacy&sensor=true&key=AIzaSyBlbRC-4r5x73rTsTMlAH9PJ8eptz3nwU4");
                ...
                public void onResponse(Call<PlacesPOJO.Root> call, Response<PlacesPOJO.Root> response) {
                    ...
                    if (response.isSuccessful()) {
                        ...
                        if (root.status.equals("OK")) {
                            ...
                            RecyclerViewAdapter adapterStores = new RecyclerViewAdapter(chemist.this,results);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
                ...
                AuthUI.getInstance()
                        ...
                        .addOnCompleteListener(new OnCompleteListener<Void>() {
                            public void onComplete(@NonNull Task<Void> task) {
                                // ...
                                Intent intent=new Intent(chemist.this,Login.class);
            ...
            case R.id.search:
                ...
                try {
                    Intent intent = new PlaceAutocomplete.IntentBuilder(PlaceAutocomplete.MODE_OVERLAY).build(chemist.this);
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode==200)
        {
            if (resultCode==RESULT_OK) {
                ...
                Place place = PlaceAutocomplete.getPlace(chemist.this, data);
