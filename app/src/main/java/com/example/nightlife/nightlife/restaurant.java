...
public class restaurant extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener{
    ...
    private void fetchStores() {
         ...
         */
        locationTrack = new LocationTrack(restaurant.this,i);
        ...
        if (locationTrack.canGetLocation()) {
            ...
            Call<PlacesPOJO.Root> call = apiService.doplaces("https://maps.googleapis.com/maps/api/place/nearbysearch/json?location="+lat+","+lon+"&radius=1500&type=restaurant&sensor=true&key=AIzaSyBlbRC-4r5x73rTsTMlAH9PJ8eptz3nwU4");
                ...
                public void onResponse(Call<PlacesPOJO.Root> call, Response<PlacesPOJO.Root> response) {
                    ...
                    if (response.isSuccessful()) {
                        ...
                        if (root.status.equals("OK")) {
                            ...
                            RecyclerViewAdapter adapterStores = new RecyclerViewAdapter(restaurant.this,results);
    ...
    private void showMessageOKCancel(String message, DialogInterface.OnClickListener okListener) {
        new AlertDialog.Builder(restaurant.this)
                .setMessage(message)
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.search:
                ...
                try {
                    Intent intent = new PlaceAutocomplete.IntentBuilder(PlaceAutocomplete.MODE_OVERLAY).build(restaurant.this);
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode==200)
        {
            if (resultCode==RESULT_OK) {
                ...
                Place place = PlaceAutocomplete.getPlace(restaurant.this, data);
